module examples/otel/tracer/server
...
require (
	...
	github.com/gone-io/goner/gin v0.0.0-00010101000000-000000000000
	github.com/gone-io/goner/otel/tracer/http v0.0.0-00010101000000-000000000000
