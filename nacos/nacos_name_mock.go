...
//
//	mockgen -destination=nacos_name_mock.go -package=nacos github.com/nacos-group/nacos-sdk-go/v2/clients/naming_client INamingClient
//
...
func (mr *MockINamingClientMockRecorder) BatchRegisterInstance(param any) *gomock.Call {
